export const Catalog = [
	{
	  ...
	  "quantity": 12,
	  "product_description": {
	    "subtitle": "An athletic look from the 1980s returns in fresh style.",
	    "text": "Steeped in nostalgia, the Continental 80 captures the retro look of indoor trainers from the early 1980s. The suede shoes feature a swooping two-colour stripe and a distinctive split rubber cupsole that's built for a comfortable, flexible feel.\n\nVintage nostalgia\nA logo window next to the laces recalls '80s styles\n\nClassic comfort\nFrench terry lining for a soft feel and a throwback look\n\nSplit cupsole \nA split rubber cupsole with an EVA insert provides a comfortable, flexible feel"
	  },
	  "breadcrumb_list": [
	    {
	      "text": "Originals",
